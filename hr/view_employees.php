...
<?php include("include/nav.php");?>
    ...
    <section class="content">
     <h3 style="background:#3c8dbc; padding:10px;">View Employees</h3>
         ...
         <div class="col-lg-12 table-responsive">   
          <table class="table table-striped">
			...
			?>
              ...
              <td><?php echo $row['emp_phone_no']; ?></td>
             	<td><a href="edit_job.php?id=<?php echo $row['id']; ?>">Job Edit</a>&nbsp;|&nbsp;<a href="edit_employee.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;|&nbsp;<a onClick="javascript: confdel('<?php echo $row['id']; ?>');" href="#">Delete</a></td>
						  </tr>
				 <?php }
				 	$n++;
					  }
