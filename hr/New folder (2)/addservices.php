...
if(isset($_POST['submit']))
{
    ...
    $status = $_POST['status'];
      ...
      header('location:addservices.php?error=Please Fill All Mandatory Fields');
    }
	else
	{
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
         ...
         <div class="row" style="padding-bottom:20px;">
             <div class="col-lg-12">   
             <form method="post" action="addservices.php" class="form-horizontal" role="form" enctype="multipart/form-data">
