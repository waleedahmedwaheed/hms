<?php include("../../conn/db.php"); 
	...
	{
		$insertSQL = "SELECT * FROM payment_mode where paymentid = '".$_GET["paymentid"]."' and pay_status = 0";
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post" id="userForm">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" placeholder="Enter name" name="payment_option" value="<?php echo $payment_option; ?>">
                                        </div>
                                       ...
                                       <?php if(isset($_GET["paymentid"]))
										...
										<a href="payments.php" class="btn btn-default">  New  </a>
										<?php } else { ?>
...
$("#loader").show();
$.ajax({
url: "save_payment.php",	  // Url to which the request is send
...
if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","view_payments.php",true);
        xmlhttp.send();
