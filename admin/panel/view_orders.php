...
<script src="../bower_components/jquery/dist/jquery.min.js"></script>
				...
				if(isset($_GET["o_id"]))
				{		
				$insertSQL = "SELECT * FROM `order` where status = '0' and o_id = '".$_GET["o_id"]."' and tbl_id <> 0 order by date desc";
				}
				else
				{
				$insertSQL = "SELECT * FROM `order` where status = '0' and tbl_id <> 0 order by date desc";	
				}
