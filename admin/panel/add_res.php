<?php include("../../conn/db.php"); 
	...
	if(isset($_GET["r_id"]))
	{
		$insertSQL = "SELECT * FROM restaurant where r_id = '".$_GET["r_id"]."'";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="save_res.php">
                                        <div class="form-group">
                                            <label>Restaurant Name</label>
                                            <input type="text" required class="form-control" name="r_name" value="<?php echo $r_name; ?>">
                                        </div>
										
										<div class="form-group">
                                            <label>Mobile</label>
                                            <input type="text" required class="form-control" name="mobile" value="<?php echo $mobile; ?>">
                                        </div>
										...
										<div class="form-group">
                                            <label>Address</label>
                                            <input type="text" required class="form-control" name="address" value="<?php echo $address; ?>">
                                        </div>
