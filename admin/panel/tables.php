<?php include("../../conn/db.php"); 
	...
	{
		$insertSQL = "SELECT * FROM tables where tbl_id = '".$_GET["tbl_id"]."' and tbl_status = 0";
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post" id="userForm">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" placeholder="Enter name" name="tbl_name" value="<?php echo $tbl_name; ?>">
                                        </div>
                                       ...
                                       <?php if(isset($_GET["tbl_id"]))
										...
										<a href="tables.php" class="btn btn-default">  New  </a>
										<?php } else { ?>
...
$("#loader").show();
$.ajax({
url: "save_table.php",	  // Url to which the request is send
...
if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","view_tables.php",true);
        xmlhttp.send();
