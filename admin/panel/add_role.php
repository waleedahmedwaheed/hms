<?php include("../../conn/db.php"); 
	...
	{
		$insertSQL = "SELECT * FROM roles where role_id = '".$_GET["role_id"]."' and role_status = 0";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="save_role.php">
                                        <div class="form-group">
                                            <label>Role Name</label>
                                            <input class="form-control" placeholder="Enter name" name="role_name" value="<?php echo $role_name; ?>">
                                        </div>
